...
namespace Login
{
    public partial class frmQuanLi : Form
    {
        ...
        private void btnSanPham_Click(object sender, EventArgs e)
        {
            ...
            controlQuanLiSanPham uc = new controlQuanLiSanPham();
            addUserControl(uc);
        }
        ...
        {
            ActiveButton(sender, RGBColors.color2);
            controlQuanLiNhanVien uc = new controlQuanLiNhanVien();
            addUserControl(uc);
        }
        ...
        private void btnHoaDon_Click(object sender, EventArgs e)
        {
            ...
            controlQuanLiHoaDon uc = new controlQuanLiHoaDon();
            addUserControl(uc);
        }
        ...
        {
            ActiveButton(sender, RGBColors.color2);
            controlQuanLiKhachHang uc = new controlQuanLiKhachHang();
            addUserControl(uc);
        }
    }
}
